Gem::Specification.new do |spec|
  ...
  spec.version       = "1.0.0"
  spec.authors       = ["Rails Route Tester Team"]
  spec.email         = ["team@railsroutetester.com"]
  ...
  spec.homepage      = "https://github.com/railsroutetester/rails_route_tester"
  spec.license       = "MIT"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/railsroutetester/rails_route_tester"
  spec.metadata["changelog_uri"] = "https://github.com/railsroutetester/rails_route_tester/blob/main/CHANGELOG.md"
end
